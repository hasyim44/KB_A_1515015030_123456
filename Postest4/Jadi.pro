...
GOAL
	pembunuh(X).			/*X adalah pelaku pembunuhan*/
					/*maka X = Budi*/
					/*Karena berdasarkan fakta pernyataan yang terbunuh adalah siti,
					 Dengan senjata pentungan yang menggunakan kaki palsu
					 dan tangan budi yang berlumuran darah
					*/